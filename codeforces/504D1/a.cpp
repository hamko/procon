...
string solve(ll n, ll m, string s_, string t_) {
    deque<ll> s(n), t(m);
    rep(i, n) {
        s[i] = s_[i];
    }
...
string part(ll n, ll m, string s1, string s2) {
    int i, ct1=0,ct2=0;
    while (1) {
        if (s1[ct1]==s2[ct2]) {
            s1[ct1]='*';
...
int main(void) {
    ...
    ll n, m; cin >> n >> m;
    string s, t; cin >> s >> t;
        if (solve(n, m, s, t) != part(n, m, s, t)) {
            cout << mt(n,m,s,t) << endl;
        }
    }
    return 0;
    while (1) {
