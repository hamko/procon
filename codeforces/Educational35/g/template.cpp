...
//    cout << q <<"#q"<<endl;
    rep(_,q){
//        cout<<_<<endl;
        int l,r,x,y;input(l),input(r),input(x),input(y);l--; if (x==y) continue;
//        p[y].OR(p[x], l, r);
//        p[x].clear(l, r);
        p[y].OR_then_clear(p[x], l, r);
    }
