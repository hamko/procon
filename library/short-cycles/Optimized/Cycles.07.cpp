...
TAnswer c7 ( ) { 
	...
	for ( i1 = 0; i1 < n; i1 ++ ) { 	
		t1=0;
		for(i2 = 0; i2 < n; i2++) {
			t1 += ( int64u ) A2[i1][i2] * A3[i2][i2];
		}
		s += TAnswer ( 7 ) * t1;
		t1 = t2 = t3 = t4 = 0;
		for(i2 = 0; i2 < n; i2++) {
			if ( A1[i1][i2] ) {
				t1 += ( int64u ) A2[i1][i2] * A2[i1][i2]*A1[i1][i2];
				t2 += ( int64u ) A2[i2][i2] * A1[i1][i2]*A2[i1][i1]*A2[i1][i2];
				t3 += ( int64u ) A1[i1][i2] * A2[i1][i2]*A3[i1][i2];
				t4 += ( int64u ) A1[i1][i2] * A2[i1][i2]*A2[i1][i2]*A2[i1][i2];
			}
		}
		...
		s += 56 * A3[i1][i1];
		s += -77 * A2[i1][i1]*A3[i1][i1];
		s += 14 * A2[i1][i1]*A2[i1][i1]*A3[i1][i1];
		s += 7 * A[4][i1][i1];
		s += -7 * A2[i1][i1]*A[4][i1][i1];
		s += -7 * A[3][i1][i1]*A3[i1][i1];
		s += A[6][i1][i1];
	} 
	return s /= 14;	
}
