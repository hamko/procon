/**
 * ---==== Counting the Number of 6-Cycles in an undirected bipartite Graph  ====---
 *
...
TAnswer c6b ( ) { 
	...
	for ( i1 = 0; i1 < n; i1 ++ ) { 
		...
		s += t2 * 3;
		s += 4 * A2[i1][i1];
		s += TAnswer(4) * A2[i1][i1]*A2[i1][i1]*A2[i1][i1];
		s += TAnswer(6) * A4[i1][i1];
		s += TAnswer(-6) * A4[i1][i1]*A2[i1][i1];
		s += A[5][i1][i1];
	}	
	return s /= 12;
}
