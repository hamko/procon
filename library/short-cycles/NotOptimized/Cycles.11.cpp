...
void c11 ( ) {
		...
		for ( i2 = 0; i2 < n; i2 ++ ) {
			for ( i3 = 0; i3 < n; i3 ++ ) {
				for ( i4 = 0; i4 < n; i4 ++ ) {
					...
					t50 += A[0][i1][i3]*A[0][i3][i4]*A[0][i2][i3]*A[0][i1][i4]*A[1][i2][i4]*A[1][i1][i1]*A[0][i1][i2];
					t51 += A[0][i1][i3]*A[0][i2][i4]*A[0][i2][i3]*A[1][i1][i4]*A[1][i1][i1]*A[0][i3][i4]*A[0][i1][i2];
					...
					t56 += A[0][i1][i3]*A[0][i2][i4]*A[0][i2][i3]*A[1][i4][i4]*A[1][i1][i1]*A[0][i3][i4]*A[0][i1][i2];
					t57 += A[1][i3][i4]*A[0][i2][i3]*A[0][i1][i4]*A[0][i1][i3]*A[0][i2][i4]*A[0][i3][i4]*A[0][i1][i2];
					t58 += A[0][i1][i3]*A[0][i2][i4]*A[0][i2][i3]*A[1][i1][i4]*A[0][i3][i4]*A[0][i1][i2];
	...
	for ( i1 = 0; i1 < n; i1 ++ ) {
		for ( i2 = 0; i2 < n; i2 ++ ) {
			for ( i3 = 0; i3 < n; i3 ++ ) {
				...
				t17 += A[0][i1][i3]*A[0][i2][i3]*A[1][i2][i3]*A[1][i1][i1]*A[0][i1][i2]*A[3][i2][i3];
				...
				t20 += A[0][i1][i3]*A[0][i2][i3]*A[0][i1][i2]*A[3][i1][i2]*A[2][i3][i3];
				...
				t29 += A[0][i1][i2]*A[1][i1][i2]*A[4][i3][i3]*A[0][i1][i3]*A[0][i2][i3];
				t30 += A[1][i1][i3]*A[3][i3][i3]*A[0][i1][i2]*A[1][i1][i2]*A[0][i2][i3];
				t31 += A[2][i3][i3]*A[2][i1][i3]*A[0][i1][i2]*A[1][i1][i2]*A[0][i2][i3];
				t32 += A[0][i1][i3]*A[0][i2][i3]*A[0][i1][i2]*A[2][i2][i3]*A[3][i1][i3];
				t33 += A[0][i1][i3]*A[0][i2][i3]*A[4][i1][i3]*A[0][i1][i2]*A[1][i2][i3];
				...
				t38 += A[0][i1][i2]*A[1][i1][i2]*A[1][i3][i3]*A[1][i1][i1]*A[1][i2][i3]*A[1][i2][i3];
				...
				t46 += A[0][i1][i3]*A[0][i2][i3]*A[1][i3][i3]*A[0][i1][i2]*A[4][i1][i2];
				...
				t55 += A[0][i1][i3]*A[0][i2][i3]*A[0][i1][i2]*A[1][i1][i3]*A[1][i1][i3]*A[1][i1][i2]*A[1][i1][i2];
				t56 += A[1][i1][i3]*A[0][i1][i3]*A[1][i2][i3]*A[0][i2][i3]*A[0][i1][i2]*A[2][i3][i3];
				t57 += A[0][i1][i2]*A[1][i1][i2]*A[0][i2][i3]*A[1][i1][i3]*A[1][i1][i3]*A[1][i1][i3];
				t58 += A[1][i1][i1]*A[0][i2][i3]*A[1][i2][i3]*A[1][i1][i2]*A[0][i1][i2]*A[1][i1][i3]*A[0][i1][i3];
				t59 += A[0][i1][i3]*A[0][i2][i3]*A[0][i1][i2]*A[1][i1][i3]*A[1][i1][i3]*A[2][i1][i2];
				...
				t64 += A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i3]*A[1][i2][i3]*A[1][i2][i3];
				t65 += A[0][i1][i2]*A[2][i3][i3]*A[1][i1][i2]*A[0][i2][i3]*A[1][i1][i3];
				t66 += A[0][i1][i3]*A[0][i2][i3]*A[1][i2][i3]*A[0][i1][i2]*A[3][i1][i1];
				...
				t79 += A[0][i1][i3]*A[0][i2][i3]*A[2][i1][i3]*A[2][i1][i2]*A[0][i1][i2];
				...
				t89 += A[1][i1][i2]*A[2][i1][i2]*A[1][i1][i3]*A[0][i1][i2];
				t90 += A[0][i1][i3]*A[0][i2][i3]*A[0][i1][i2]*A[2][i2][i3]*A[1][i1][i1]*A[1][i1][i1];
				...
				t112 += A[0][i1][i2]*A[1][i1][i2]*A[0][i2][i3]*A[1][i1][i3]*A[1][i1][i1]*A[0][i1][i3];
				t113 += A[0][i1][i3]*A[1][i1][i3]*A[1][i1][i3]*A[1][i1][i2];
				t114 += A[0][i1][i3]*A[0][i2][i3]*A[1][i1][i3]*A[1][i1][i1]*A[1][i2][i2]*A[0][i1][i2];
				t115 += A[0][i1][i3]*A[0][i2][i3]*A[1][i3][i3]*A[0][i1][i2]*A[2][i1][i2];
				t116 += A[0][i1][i2]*A[1][i1][i2]*A[0][i2][i3]*A[1][i1][i3]*A[1][i3][i3];
				t117 += A[0][i1][i3]*A[0][i2][i3]*A[1][i2][i3]*A[0][i1][i2]*A[1][i1][i1]*A[1][i1][i1];
				t118 += A[1][i2][i3]*A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i1];
				t119 += A[0][i1][i2]*A[1][i2][i2]*A[0][i2][i3]*A[0][i1][i3]*A[1][i3][i3]*A[1][i1][i1];
				t120 += A[0][i1][i3]*A[0][i2][i3]*A[1][i1][i3]*A[1][i1][i2]*A[0][i1][i2];
				t121 += A[0][i1][i3]*A[0][i2][i3]*A[1][i2][i3]*A[1][i1][i1]*A[0][i1][i2];
			}
		}
	}
	s += t1 * ( -11 );
	...
	for ( i1 = 0; i1 < n; i1 ++ ) {
		for ( i2 = 0; i2 < n; i2 ++ ) {
			...
			t35 += A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i1]*A[2][i2][i2]*A[2][i2][i2];
			...
			t40 += A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i1]*A[2][i1][i2]*A[2][i1][i2];
			t41 += A[0][i1][i2]*A[1][i1][i1]*A[1][i1][i2]*A[1][i1][i2]*A[3][i1][i2];
			t42 += A[2][i1][i1]*A[0][i1][i2]*A[2][i1][i2]*A[2][i1][i2];
			t43 += A[2][i1][i1]*A[0][i1][i2]*A[3][i1][i2]*A[1][i1][i2];
			...
			t57 += A[0][i1][i2]*A[1][i1][i1]*A[2][i1][i2]*A[3][i1][i2];
			t58 += A[0][i1][i2]*A[1][i1][i1]*A[4][i1][i2]*A[1][i1][i2];
			t59 += A[4][i2][i2]*A[2][i1][i2];
			t60 += A[1][i1][i1]*A[1][i1][i2]*A[4][i1][i1];
			...
			t65 += A[2][i1][i2]*A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i2]*A[1][i1][i2];
			...
			t70 += A[1][i1][i2]*A[2][i1][i2]*A[0][i1][i2]*A[2][i1][i1];
			...
			t81 += A[1][i1][i2]*A[2][i1][i2]*A[1][i2][i2]*A[1][i1][i1]*A[0][i1][i2];
			...
			t93 += A[1][i1][i2]*A[2][i1][i2]*A[1][i2][i2]*A[1][i1][i1];
			t94 += A[1][i1][i2]*A[4][i2][i2];
			t95 += A[0][i1][i2]*A[1][i1][i1]*A[3][i1][i2]*A[1][i2][i2];
			...
			t102 += A[2][i1][i1]*A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i2];
			t103 += A[2][i1][i1]*A[0][i1][i2]*A[2][i2][i2];
			t104 += A[0][i1][i2]*A[1][i1][i1]*A[1][i1][i2]*A[1][i1][i2]*A[1][i2][i2];
			t105 += A[1][i1][i1]*A[1][i1][i2]*A[2][i2][i2]*A[0][i1][i2];
			...
			t109 += A[1][i1][i1]*A[1][i1][i2]*A[0][i1][i2]*A[2][i1][i2];
			t110 += A[2][i1][i2]*A[2][i2][i2];
			t111 += A[1][i1][i1]*A[1][i1][i2]*A[2][i1][i1];
			...
			t115 += A[1][i1][i1]*A[0][i1][i2]*A[1][i1][i2]*A[1][i1][i2];
			t116 += A[2][i1][i2]*A[1][i1][i2]*A[0][i1][i2];
			t117 += A[2][i2][i2]*A[1][i1][i2];
			t118 += A[1][i1][i1]*A[1][i1][i2]*A[0][i1][i2]*A[1][i2][i2];
