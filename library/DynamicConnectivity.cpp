...
typedef int ll; typedef vector<int> vl; typedef pair<int,int> pll; typedef vector<pair<int,int> > vpll;
...
using ll = int; using vll = vector<ll>; using vvll = vector<vll>; using vld = vector<ld>; 
