...
//    cout << n1 << " " << n2 << " " << n4 << endl;
    ...
    rep(i, 26) { ll x = c['a'+i] / 4; chmin(x, n4); c['a'+i] -= 4 * x; n4 -= 4 * x; }
    rep(i, 26) { ll x = c['a'+i] / 2; chmin(x, n2); c['a'+i] -= 2 * x; n2 -= 2 * x; }
    rep(i, 26) { ll x = c['a'+i] / 1; chmin(x, n1); c['a'+i] -= 1 * x; n1 -= 1 * x; }
    if (n1 == 0 && n2 == 0 && n4 == 0) cout << "Yes" << endl;
    else 
