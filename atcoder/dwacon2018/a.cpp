...
int main(void) {
    ...
    */
    ...
    rep(i, 1e7) {
        ...
        mpos %= (12ll * 60ll * 60ll);
        hpos %= (12ll * 60ll * 60ll);
//        cout << i << " " << mt(c1, c2) << mt(spos, mpos, hpos) << endl;

        bool skip = 0;
        if (spos < mpos && spos + 720ll >= mpos + 12ll) {
            skip |= spos + 720ll == mpos + 12ll;
//            cout << "C1 HIT" << endl;
            c1--;
        }
        if (mpos < hpos && mpos + 12ll >= hpos + 1ll) {
            skip |= mpos + 12ll == hpos + 1ll;
//            cout << "C2 HIT" << endl;
            c2--;
        }
        if (c1 < 0 || c2 < 0) {
