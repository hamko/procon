...
class DigitRotation {
    public:
        int sumRotations(string X) {
            ...
            vector<mint> pow10;
            pow10.pb(1);
            rep(i, 10000) pow10.pb(pow10.back()*mint(10));
...
//                    cout << mt(i,j,k,mint(10)^(n-1-i)) << endl;;
                    ret += x;
                    ret += mint(s[k] - s[i]) * pow10[n - 1 - i];
                    ret += mint(s[i] - s[j]) * pow10[n - 1 - j];
                    ret += mint(s[j] - s[k]) * pow10[n - 1 - k];
                }
            }
            return ret.x;
        }
...
int main() {
	...
	// ------------------
		// ----- test 3 -----
	disabled = false;
	p0 = "";
	p1 = -1;
	all_right = (disabled || KawigiEdit_RunTest(3, p0, false, p1) ) && all_right;
	tests_disabled = tests_disabled || disabled;
	// ------------------
